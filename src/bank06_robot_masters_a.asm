...
code_A7B4:  lda     ent_anim_state,x
        bne     code_A7D7
        dec     ent_timer,x
        bne     code_A7CE
        lda     #$2E
...
code_A7D7:  lda     ent_anim_frame,x
        and     #$08
        beq     code_A7E1
        inc     ent_anim_state,x
